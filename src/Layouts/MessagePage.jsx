...
const MessagePage = () => {
  return (
    <div class="flex items-center justify-center h-screen">
      <div class="flex flex-col justify-center items-center bg-primary text-white rounded-lg shadow-lg p-6 w-full h-full">
        <img src={logoImg} alt="Logo" class="w-30 rounded-full mb-4" />
        ...
        <button
          ...
          class="bg-gradient-to-r mt-4 from-[#AA2B1D] to-[#CC561E] text-white font-bold py-2 px-4 rounded-full animate-pulse"
        >
          Go Back
        </button>
      </div>
